...
export default function SearchAutocomplete({
  ...
  const suggestions = (() => {
    ...
    if (!q) return [];
    const filtered = ALL_STATIC.filter((s) =>
      ...
      {open && value.trim() && (
        ...
        >
          ...
          {suggestions.map((item, i) => {
            const colors =
              CATEGORY_COLORS[item.category] || CATEGORY_COLORS.Keyword;
          ...
          {value.trim() && (
                  <div
                    ...
                    style={{
                      ...
                      cursor: "pointer",
                      background:
                        highlighted === suggestions.length ? "#f9f9f9" : "#fff",
